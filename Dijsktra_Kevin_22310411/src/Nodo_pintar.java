...
public class Nodo_pintar {
    ...
    public Nodo_pintar(int x, int y, int diameter, String text) {
        this.selected = false;
        this.x = x;
        this.y = y;
    ...
    public void initialize() {
        background = new Color(120,200,120);
    ...
    public void paint(Graphics g) {
        ...
        g2d.setColor(new Color(30,  145,  190)); //Seteamos el color del borde del nodo al crearlo
        g2d.draw(circle);

        double textFix = (8 * text.length());
        g2d.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 19));
    ...
    public void changeColor() {
        ...
        if(selected) {
                background = new Color(182, 226, 161);
        }else {
            background = new Color(104,208,41);
        }
    }
